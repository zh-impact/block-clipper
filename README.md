...
#### 导出所有内容
1. 打开 Options 页面
2. 点击顶部的"Export All as JSON"或"Export All as Markdown"按钮
3. 确认导出

#### 导出单条内容
1. 在 Side Panel 中打开某条剪藏的详情
2. 点击"Export JSON"或"Export Markdown"按钮
...
### Q: 可以在不同设备间同步剪藏吗？
A: 目前不支持。但你可以使用导出功能，然后手动导入到其他设备（未来版本可能会支持同步）。
